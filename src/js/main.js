  ...
  var app = (function appController() {
    return {
      ...
      createNewCar: function createNewCar() {
        ...
        $img.setAttribute('src', carData.imagem);
        $img.setAttribute('class', 'carroimage');
        $tdImagem.appendChild($img);

        var $tdMarcaModelo = doc.createElement('td');
        $tdMarcaModelo.textContent = carData.marcaModelo;

        var $tdAno = doc.createElement('td');
        $tdAno.textContent = carData.ano;

        var $tdPlaca = doc.createElement('td');
        $tdPlaca.textContent = carData.placa;

        var $tdCor = doc.createElement('td');
        $tdCor.textContent = carData.cor;
      ...
      getCarData: function getCarData() {
        return {
          imagem: DOM('[data-js-id="carro-imagem"]').getFirst().value,
          marcaModelo: DOM('[data-js-id="carro-marca-modelo"]').getFirst().value,
          ano: DOM('[data-js-id="carro-ano"]').getFirst().value,
          placa: DOM('[data-js-id="carro-placa"]').getFirst().value,
          cor: DOM('[data-js-id="carro-cor"]').getFirst().value,
        };
      },
    };
  })();
